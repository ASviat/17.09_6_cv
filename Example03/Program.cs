Console.WriteLine("Введите число от 1 до 7, дабы познать, что за день за ним скрыт.");
...
if (num!=1 &&num!=2 && num!=3 && num!=4 && num!=5 && num!=6 && num!=7) Console.WriteLine("Ты болен? От 1 до 7.");


Console.WriteLine("Гадания на кофейной гуще +375 29 666 66 66");
